...
public class DBOperations {
    ...
    public JSONArray searchCollege(String cat,String state,String city,String keyword){
        String url = QUIZ_API_URL + "searchColleges.php";
        String tableId = "";
        switch (cat) {
            case "Engineering":
                tableId = "engineering_colleges";
    ...
    public JSONObject getCollegeInfo(String id,String table){
        String url = QUIZ_API_URL + "getCollegeInfo.php";
        HashMap<String,String> map = new HashMap<>();
        map.put(ID,id);
        map.put(TABLE_ID,table);
        String paramStr = setParameters(map);
        String result = execute(url,paramStr);
