...
public class Constants {
    ...
    public static String BASE_API_URL="https://dhruvaism9999.000webhostapp.com/think2exam/services/";
    ...
    public static String QUIZ_OPTION_1 = "option1";
    public static String QUIZ_OPTION_2 = "option2";
    public static String QUIZ_OPTION_3 = "option3";
    public static String QUIZ_OPTION_4 = "option4";
